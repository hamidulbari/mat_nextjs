                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                        ...
                        <div className="content-wrapper flex flex-col justify-between gap-15">
                            ...
                            <div className="social-media">
                                ...
                                <ul className='flex flex-row gap-5'>
                                    <li>
                                        <a className='w-[50px] h-[50px] flex justify-center items-center rounded  bg-[var(--box-bg-color)] hover:bg-white hover:text-blue-600 transition-[var(--global-transitions)]' href="#" target='_blank'>
                    ...
                    <div className="item">
                        <div className="content-wrapper">
                            <h3>About MAT</h3>
                            <p>
                                The Management Aptitude Test (MAT), conducted by AIMA since 1988, is one of India’s most trusted entrance exams for MBA and PGDM programs. Recognized by the Government of India, MAT connects aspirants to 600+ B-Schools nationwide.
                    ...
                    <div className="item">
                        <div className="content-wrapper">
                            ...
                            <ul className='flex flex-col gap-3'>
                                ...
                                <li><a href="#">MAT Score & Interpretation</a></li>
                    ...
                    <div className="item">
                        <div className="content-wrapper">
                            ...
                            <ul className='flex flex-col gap-3'>
                                <li>
                                    <a href="mailto:mat@aima.in" className='flex flex-row items-center gap-4'> <BsEnvelopeAt size={25} />
                                        <span>mat@aima.in</span>
                                    </a>
                                </li>
                                <li>
                                    <div className='flex flex-row items-center gap-4'> <BsTelephone size={25} />
